...
let m = new THREE.PointsMaterial({
  ...
  onBeforeCompile: (shader) => {
    ...
    `
      ...
      .replace(`vec4 diffuseColor = vec4( diffuse, opacity );`, `vec4 diffuseColor = vec4( vColor, smoothstep(0.5, 0.1, d)/* * 0.5 + 0.5*/ );`);
...
loginForm.addEventListener('submit', handleWelcomeSubmit);
